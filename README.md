...
* [Pagetree Facets](https://docs.typo3.org/p/xima/xima-typo3-content-planner/main/en-us/Usage/PagetreeFacets.html) filter facet for the optional `konradmichalik/typo3-pagetree-facets` extension (TYPO3 v13+)
