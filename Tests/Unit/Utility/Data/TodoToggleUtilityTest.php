...
final class TodoToggleUtilityTest extends TestCase
{
    ...
    /**
     * Content saved through the RTE is already canonical HTML (double-quoted attributes,
     * non-self-closing void elements) - toggle() reproduces that form exactly, so this is the
     * form every comment actually saved through the backend round-trips through unchanged.
     */
    #[Test]
     ...
     * equivalent HTML, not data loss, and it never affects RTE-authored content.
     */
    #[Test]
