...
final class PlannerServiceTest extends TestCase
{
    ...
    {
        $expected = [new Status(uid: 1, title: 'Draft', icon: '', color: '', isDefault: false)];
    ...
    {
        $status = new Status(uid: 0, title: 'In Progress', icon: '', color: '', isDefault: false);
    ...
    {
        $status = new Status(uid: 3, title: '', icon: '', color: '', isDefault: false);
    ...
    {
        $status = new Status(uid: 5, title: '', icon: '', color: '', isDefault: false);
    ...
    public function updateStatusForRecordResolvesStatusEntityToUid(): void
    {
        ...
        $status = new Status(uid: 7, title: '', icon: '', color: '', isDefault: false);
    ...
    {
        $this->stubExistingPageRecord();
        $status = new Status(uid: 2, title: '', icon: '', color: '', isDefault: false);
