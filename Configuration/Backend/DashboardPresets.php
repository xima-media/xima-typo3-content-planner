...
return [
    'default' => [
        ...
        'defaultWidgets' => ['contentStatus-notes', 'contentStatus-overview', 'contentStatus-current', 'contentStatus-update', 'contentStatus-danger', 'contentStatus-info', 'contentStatus-warning', 'contentStatus-success', 'contentStatus-comment'],
        'showInWizard' => true,
    ],
];
