...
final readonly class ModifyRecordListTableActionsListener
{
    ...
    public function __invoke(ModifyRecordListTableActionsEvent $event): void
    {
        ...
        $action = '<div class="btn-group" style="margin-left:10px;">
                <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" title="'.htmlspecialchars($statusLabel, \ENT_QUOTES | \ENT_HTML5).'" aria-label="'.htmlspecialchars($statusLabel, \ENT_QUOTES | \ENT_HTML5).'">'.
